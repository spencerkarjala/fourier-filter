...
FFTBuffer::FFTBuffer(unsigned numChannels, unsigned size, unsigned fftOrder, unsigned windowSize, unsigned numOverlaps, std::function<void(std::complex<float>*, unsigned int)> processFFT)
